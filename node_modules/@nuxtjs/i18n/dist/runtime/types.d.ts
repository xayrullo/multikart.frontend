 ...
 */
type BeforeLanguageSwitchHandler = (oldLocale: string, newLocale: string, initialSetup: boolean, context: NuxtApp) => Promise<string | void>;
/**
...
export interface ComposerCustomProperties<ConfiguredLocaleType extends string[] | LocaleObject[] = string[] | LocaleObject[]> {
    /**
     * List of locales
     *
     * @remarks
...
export interface NuxtI18nRoutingCustomProperties<ConfiguredLocaleType extends string[] | LocaleObject[] = string[] | LocaleObject[]> {
    /**
     * List of locales
     *
     * @remarks
